        ...
        <div className="userShow">
            <div className="userShowTop">
                ...
                <div className="userShowTopTitle">
                    <span className="userShowUsername">Anna lee</span>
                    <span className="userShowUserTitle">UI Developer</span>
                </div>
            </div>
            <div className="userShowBottom">
                ...
                <div className="userShowInfo">
                    ...
                    <span className="userShowInfoTitle">anna96</span>
                </div>
                <div className="userShowInfo">
                ...
                <div className="userShowInfo">
                    ...
                    <span className="userShowInfoTitle">anna96@gmail.com</span>
                </div>
                <div className="userShowInfo">
